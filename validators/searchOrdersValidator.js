...
module.exports = app => {
    let schemas = app.validators.schemas.searchOrdersSchema;
    let logger = app.helpers.logger;
    let errorFormatter = app.helpers.errorFormatter;

    function validateSearchOrderParams (params) {
        ...
        return new Promise((resolve, reject) => {
            joi.validate(params, schemas.searchOrdersParamsSchema, joiValidationOption, err => {
                if (err) {
